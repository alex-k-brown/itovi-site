...
class Nexus_News_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			array( 'description' => __( 'Insert your Latest News', 'nexus' ), )
		);
	}
...
class Nexus_Socials_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			...
			array( 'description' => __( 'Insert your Social Links', 'nexus' ), )
		);
	}
...
class Nexus_Contact_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			array( 'description' => __( 'Insert a Contact Information', 'nexus' ), )
		);
	}
...
class Nexus_Testimonials_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'Nexus Testimonials Widget', 'nexus' ),
			array( 'description' => __( 'Insert a Testimonials', 'nexus' ), )
		);
	}
